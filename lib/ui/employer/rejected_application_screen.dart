...
class RejectedApplicationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rejectedApplications = applicationStorage.rejectedApplications;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: false,
        title: Text(
          'Hồ sơ đã từ chối (${applicationStorage.failApplicationNumber})',
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const Expanded(
                child: Text(
                  'Danh sách những ứng viên đã bị từ chối',
          ...
          rejectedApplications.isNotEmpty
              ? ListView.builder(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: ApplicantCard(
                        application: rejectedApplications[index],
                        isRead: true,
              ...
              : SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Hiện tại chưa có ứng viên nào bị từ chối',
                        style: textTheme.bodyLarge,
                      ),
                    ],
                  ),
